...
import { MdOutlineViewInAr, MdSave } from "react-icons/md";
...
export default function EditCategoryPage({
  ...
  // Fetch category data and existing categories
  useEffect(() => {
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  {categories
                    .filter((cat) => cat.id !== Number(slug)) // Exclude current category from parent options
                    .map((cat) => (
